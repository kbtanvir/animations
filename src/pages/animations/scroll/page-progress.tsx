...
export default function App() {
  ...
  return (
    <>
      <div className="bg-yellow-200 p-20 h-[250vh] flex-center flex-col">
        <motion.div
          className=" fixed top-0 right-0 left-0 h-[10px] bg-red-500 origin-left"
          style={{ scaleX }}
        />
        <h1 className="fixed top-20 text-5xl text-red-500 bg bg-yellow-200 p-10 ">
          Keep Scrolling
        </h1>
        <LoremIpsum />
        <LoremIpsum />
